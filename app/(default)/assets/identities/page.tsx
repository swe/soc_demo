...
export default function IdentitiesPage() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="mb-8">
        {/* Main title */}
        <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold mb-2">Identities</h1>
        {/* Subheader */}
        <p className="text-gray-600 dark:text-gray-400 text-lg">Manage and monitor identity access and permissions</p>
      </div>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <div className="h-24 flex items-center justify-center">
                  <span className="text-gray-400 dark:text-gray-500">Top Inner Tile (Full width)</span>
                </div>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <div className="h-24 flex items-center justify-center">
                  <span className="text-gray-400 dark:text-gray-500">Bottom Inner Tile (Full width)</span>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-12 sm:col-span-6 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <div className="h-20 flex items-center justify-center">
                  <span className="text-gray-400 dark:text-gray-500">Top Left (1/2 width)</span>
                </div>
              </div>
              <div className="col-span-12 sm:col-span-6 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <div className="h-20 flex items-center justify-center">
                  <span className="text-gray-400 dark:text-gray-500">Top Right (1/2 width)</span>
                </div>
              </div>
              <div className="col-span-12 sm:col-span-6 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <div className="h-20 flex items-center justify-center">
                  <span className="text-gray-400 dark:text-gray-500">Bottom Left (1/2 width)</span>
                </div>
              </div>
              <div className="col-span-12 sm:col-span-6 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <div className="h-20 flex items-center justify-center">
                  <span className="text-gray-400 dark:text-gray-500">Bottom Right (1/2 width)</span>
                </div>
              </div>
            </div>
          )}
