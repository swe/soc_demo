            ...
            <div className="max-w-sm mx-auto w-full px-4 py-8">
              ...
              <form>
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  <Link className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white ml-3 whitespace-nowrap" href="/overview">Sign Up</Link>
                </div>
              </form>
              {/* Footer */}
              <div className="pt-5 mt-6 border-t border-gray-100 dark:border-gray-700/60">
                <div className="text-sm">
                  Have an account? <Link className="font-medium text-indigo-600 hover:text-indigo-600 dark:hover:text-indigo-500" href="/overview/signin">Sign In</Link>
                </div>
              </div>
            </div>
