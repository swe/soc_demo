    ...
    <div className="py-8 w-full max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 px-4">
        <div className="hig-card bg-gray-50 dark:bg-[#334155]/30 p-4 text-center">
          ...
          <div className="hig-caption text-[#007AFF] mt-1">Last 5 minutes</div>
        </div>
        ...
        <div className="hig-card bg-gray-50 dark:bg-[#334155]/30 p-4 text-center">
          ...
          <div className="hig-caption text-[#34C759] mt-1">{Math.round((stats.blocked / stats.total) * 100)}% blocked</div>
        </div>
        ...
        <div className="hig-card bg-gray-50 dark:bg-[#334155]/30 p-4 text-center">
          ...
          <div className="hig-caption text-[#FF3B30] mt-1">Needs attention</div>
        </div>
        ...
        <div className="hig-card bg-gray-50 dark:bg-[#334155]/30 p-4 text-center">
          ...
          <div className="hig-caption text-[#FF9500] mt-1">Ongoing</div>
        </div>
      </div>
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto">
              {filteredEvents.map((event) => {
                ...
                return (
                  <div 
                    key={event.id} 
                    className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-[#334155]/30 rounded-lg"
                  >
                    <div 
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between hig-caption text-gray-500 dark:text-gray-400">
                        ...
                        {event.blocked ? (
                          <span className="text-[#34C759] font-medium">BLOCKED</span>
                        ) : (
                          <span className="text-[#FF9500] font-medium">ACTIVE</span>
                        )}
                      </div>
                    </div>
                  </div>
          ...
          <div className="hig-card">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {attackTypes.map((type, idx) => {
                ...
                return (
                  <div key={idx} className="hig-card bg-gray-50 dark:bg-[#334155]/30 p-4 text-center">
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div 
                        className="bg-[#393A84] dark:bg-[#393A84] h-2 rounded-full transition-all duration-200" 
