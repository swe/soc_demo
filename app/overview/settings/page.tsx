      ...
      <div className="space-y-6 px-4">
        ...
        <div className="hig-card">
          ...
          <div className="space-y-5">
            ...
            <div>
              <label className="block hig-body font-medium text-gray-700 dark:text-gray-300 mb-2">Email Address</label>
              <input 
                type="email" 
                value={profile.email}
                readOnly
                className="hig-input w-full bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-500 cursor-not-allowed"
              />
              <p className="hig-caption text-gray-500 dark:text-gray-400 mt-1">Email cannot be changed</p>
            </div>

            <div>
              <label className="block hig-body font-medium text-gray-700 dark:text-gray-300 mb-2">Phone Number</label>
              <input 
                type="tel" 
                value={profile.phone}
            ...
            <div>
              <label className="block hig-body font-medium text-gray-700 dark:text-gray-300 mb-2">Timezone</label>
              <select 
              ...
              <button
                ...
                className={`px-6 py-4 rounded-lg border-2 hig-body font-medium ${
                  theme === t
                    ...
                    : 'border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700/20'
                }`}
              >
