...
export default function ReportsPage() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold mb-2">Security Reports</h1>
        <p className="text-gray-600  dark:text-gray-400">Access security reports, compliance documents, and incident analyses</p>
      </div>
