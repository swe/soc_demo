      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="text-4xl md:text-5xl font-uncut-sans">Sound too good? Hear what our customers have to say</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto sm:max-w-none grid gap-12 sm:grid-cols-2 md:grid-cols-3 sm:gap-x-6 sm:gap-y-8 items-start" data-aos-id-testimonials>
            ...
            <article className="h-full flex flex-col bg-gray-800 p-6" data-aos="fade" data-aos-anchor="[data-aos-id-testimonials]">
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">Compared to other offerings, Svalbard Intelligence always has a head start and introduces bleeding edge features first.</p>
              </div>
            ...
            <article className="h-full flex flex-col bg-gray-800 p-6" data-aos="fade" data-aos-anchor="[data-aos-id-testimonials]" data-aos-delay="100">
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">Svalbard Intelligence has made a huge impact on compliance, while helping us become more transparent.</p>
              </div>
              <footer className="text-sm text-gray-400">
            ...
            <article className="h-full flex flex-col bg-gray-800 p-6" data-aos="fade" data-aos-anchor="[data-aos-id-testimonials]" data-aos-delay="300">
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">Svalbard Intelligence is the tool devs. The more you can make work feel native for a developer, the more cool their experience.</p>
              </div>
              <footer className="text-sm text-gray-400">
            ...
            <article className="h-full flex flex-col bg-gray-800 p-6" data-aos="fade" data-aos-anchor="[data-aos-id-testimonials]" data-aos-delay="400">
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">Svalbard Intelligence comes into play during the entire software life cycle. It's the de facto tool for anything related to our software.</p>
              </div>
              <footer className="text-sm text-gray-400">
            ...
            <article className="h-full flex flex-col bg-gray-800 p-6" data-aos="fade" data-aos-anchor="[data-aos-id-testimonials]" data-aos-delay="500">
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">I have no tech skills and with Svalbard Intelligence I can actually make good looking apps with ease.</p>
              </div>
              <footer className="text-sm text-gray-400">
            ...
            <article className="h-full flex flex-col bg-gray-800 p-6" data-aos="fade" data-aos-anchor="[data-aos-id-testimonials]" data-aos-delay="700">
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">Tools like Svalbard Intelligence Advanced Security help keep our team lean. It makes us much more efficient.</p>
              </div>
              <footer className="text-sm text-gray-400">
            ...
            <article className="h-full flex flex-col bg-gray-800 p-6" data-aos="fade" data-aos-anchor="[data-aos-id-testimonials]" data-aos-delay="800">
              ...
              <div className="grow mb-3">
                <p className="text-gray-400">Svalbard Intelligence enables speed and scale. We can work on bigger projects and finish them faster.</p>
              </div>
              <footer className="text-sm text-gray-400">
