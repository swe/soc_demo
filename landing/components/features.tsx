      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="text-center pb-12 md:pb-20">
            <h2 className="text-4xl md:text-5xl font-uncut-sans" data-aos="zoom-out">Focus on solving bigger problems</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="flex flex-col items-center" data-aos="zoom-out">
              ...
              <h4 className="text-2xl font-uncut-sans text-gray-200 text-center mb-2">Ready for the future</h4>
              <p className="text-base text-gray-400 text-center">A flexible foundation that evolves with complex ecosystem.</p>
            </div>
            {/* 2nd item */}
