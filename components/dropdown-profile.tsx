    ...
    <Menu as="div" className="relative inline-flex">
      <MenuButton className="inline-flex justify-center items-center group">
        <div className="flex items-center truncate">
          <span className="truncate text-sm font-medium text-gray-600 dark:text-gray-100 group-hover:text-gray-800 dark:group-hover:text-white">{name}</span>
      ...
      >
        <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
          ...
          {email && <div className="text-xs text-gray-500 dark:text-gray-400 italic">{email}</div>}
        </div>
        <MenuItem>
        ...
        <MenuItem>
          <button
            ...
            className="w-full text-left font-medium text-sm flex items-center py-1 px-3 text-indigo-600 hover:bg-gray-50 dark:hover:bg-gray-700/50 data-[focus]:bg-gray-50 dark:data-[focus]:bg-gray-700/50"
          >
            Sign Out
          </button>
        </MenuItem>
